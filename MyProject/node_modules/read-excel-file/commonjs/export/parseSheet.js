 ...
 */
function parseSheet(createWorkerFunction, parseXmlStream, contents, sheet, options) {
  return (0, _parseSpreadsheetContents["default"])(createWorkerFunction, parseXmlStream, contents, _objectSpread(_objectSpread({}, options), {}, {
    sheets: [sheet === undefined ? 1 : sheet]
  })).then(function (sheets) {
    var sheetData = sheets[0].data;
    if (options && options.schema) {
      return (0, _parseSheetData["default"])(sheetData, options.schema);
    }
    return sheetData;
  });
}
